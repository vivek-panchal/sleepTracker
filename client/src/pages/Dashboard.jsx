...
const Dashboard = () => {
    ...
    async function handleCreate(e) {
        e.preventDefault();
        try {
            const res = await axios.post("https://sleep-app-gamma.vercel.app/api/sleep", { hours, timestamp: date }, config);
    ...
    async function handleDelete() {
        try {
            await axios.delete(`https://sleep-app-gamma.vercel.app/api/sleep/${deleteRecordId}`, config);
    ...
    async function handleUpdate(e) {
        e.preventDefault();
        try {
            const res = await axios.put(`https://sleep-app-gamma.vercel.app/api/sleep/${editRecordId}`, { hours: editHours, timestamp: editDate }, config);
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const res = await axios.get(`hhttps://sleep-app-gamma.vercel.app/api/sleep/${userId}`, config);
